...
export default function MoonHairDashboardClient() {
	const hemisphere = useHemisphere();
	
	// Get moon phase timing information with hemisphere
	const moonPhaseData = getMoonPhaseWithTiming(new Date(), hemisphere);
					...
					<div className="lg:flex-1 lg:flex lg:flex-col lg:gap-15">
						...
						<div className="flex flex-col gap-4">
							<h3 className="text-2xl font-bold font-sans pb-4 md:pb-8">
								...
								{hemisphere === "Southern" && <span className="text-sm font-normal">(Southern Hemisphere)</span>}
							</h3>
