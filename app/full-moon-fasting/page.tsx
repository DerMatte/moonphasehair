  ...
  return (
    <main className="min-h-screen">
      <div className="w-full max-w-7xl mx-auto px-4 py-8">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-2">Full Moon Fasting</h1>
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  The full moon's gravitational pull affects our bodies in profound ways
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold mb-1">Enhanced Detoxification</h4>
                      <p className="text-sm text-muted-foreground">
                        The moon's gravitational peak enhances your body's natural detox processes, 
                        making it the ideal time for cleansing through fasting.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Experience heightened awareness and spiritual connection as your mind 
                        becomes clearer during the fast.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Align your body's rhythms with lunar cycles for improved sleep, 
                        mood regulation, and overall hormonal health.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Connect with ancestral practices that have recognized the moon's 
                        influence on human health for millennia.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex items-center justify-center">
            <div className="w-full max-w-md">
              ...
              <p className="text-center mt-4 text-sm text-muted-foreground">
                Current Phase: {moonData.current.name}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full">
          <Suspense fallback={
            <div className="flex items-center justify-center min-h-[400px]">
              <div className="animate-pulse text-muted-foreground">Loading fasting options...</div>
            </div>
          }>
            <FastingClient 
