...
export function Navbar({ locationData }: { locationData: LocationData | null }) {
            ...
            <div className="py-2 space-y-1 border-t border-neutral-200 w-full">
              <motion.div variants={linkVariants}>
                <Link
                  ...
                  className={cn(buttonVariants({ variant: "ghost" }), "px-3 py-1 rounded bg-transparent hover:bg-neutral-300 transition-colors text-sm font-medium w-full flex justify-start items-center ",
